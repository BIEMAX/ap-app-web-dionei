  ...
  createInfos() {
    this.listInfoAbout = [
      new AboutModels(
        ...
        `Um cara determinado, que começou muito novo
        na área de TI e hoje é completamente 
        apaixonado pelo o que faz.
        
        Tenho 27 anos, sou casado com uma linda 
        mulher, atualmente sem filhos e 
        sem animais de estimação.

        Um apaixonado por literatura, Marvel, 
        DC Comics, senhor dos anéis, jogos 
        de mais variados tipos, cozinheiro
        por natureza e admirador da física
        quântica.

        Sou um nerd desde sempre, e sou 
        completamente fascinado pela física
        aplicada, quântica, matemática e 
        astronomia (estudo dos astros).
        `,
        false, false
      ),
      new AboutModels(
